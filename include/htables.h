...
*/
extern uint8_t htables_nb_symb_per_lengths[SAMPLE_TYPES][COLOR_COMPONENTS][16];

/*
    Table des symboles, indexée par le type d'échantillon (DC ou AC) et la
    composante de couleur (Y, Cb ou Cr).
*/
extern uint8_t *htables_symbols[SAMPLE_TYPES][COLOR_COMPONENTS];
...
*/
extern uint8_t htables_nb_symbols[SAMPLE_TYPES][COLOR_COMPONENTS];
